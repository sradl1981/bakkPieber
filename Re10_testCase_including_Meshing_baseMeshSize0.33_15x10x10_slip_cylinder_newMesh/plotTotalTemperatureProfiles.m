...
folderPathSphere = 'postProcessing/zTemperatureProfileInSolid/solidSphere/';
...
dimensionlessTemperatureProfileFluidDownstream = 1 - (temperatureProfileFluidDownstream(:,2,:) - fluidInletTemperature) ./ (solidInitialTemperature - fluidInletTemperature);

dimensionlessTemperatureProfileFluidUpstream = 1 - (temperatureProfileFluidUpstream(:,2,:) - fluidInletTemperature) ./ (solidInitialTemperature - fluidInletTemperature);

dimensionlessTemperatureProfileSphere = 1 - (temperatureProfileSphere(:,2,:) - fluidInletTemperature) ./ (solidInitialTemperature - fluidInletTemperature);
...
Theta = 1 - dimensionlessTemperatureDifferenceCrank(dimensionlessRadius, FourierNumber, BiotNumberRanzMarshall, rootValues);
...
for k = 1 : length(times)
      ...
      text(-0.21, min(ThetaForPlot(:,k)) + 0.075, lineLabel, 'interpreter', 'latex', 'FontSize', fontSizeText); 
end
