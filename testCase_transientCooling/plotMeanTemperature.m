...
dimensionlessTemperature = (solidTemperature - fluidInletTemperature) ./ (solidInitialTemperature - fluidInletTemperature);

rootValues = rootsOfTranscendentalEquationCrank(BiotNumberRanzMarshall, numberOfConsideredSeriesElements);

ThetaMean = dimensionlessMeanTemperatureDifference(FourierNumber, BiotNumberRanzMarshall, rootValues);
