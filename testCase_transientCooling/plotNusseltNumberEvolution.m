...
filePath_volumeAverageSolidTemperature = strcat('postProcessing/bedOfSpheres/averageSolidTemperature/', num2str(offsetTime), '/cellSource.dat');

filePath_surfaceAverageSolidTemperature = strcat('postProcessing/bedOfSpheres/averageSurfaceTemperatureSolid/', num2str(offsetTime),'/faceSource.dat');

filePath_volumeIntegratedSolidTemperature = strcat('postProcessing/bedOfSpheres/volumeIntegratedSolidTemperature/', num2str(offsetTime),'/cellSource.dat');
